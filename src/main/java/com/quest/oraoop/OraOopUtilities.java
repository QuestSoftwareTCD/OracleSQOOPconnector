  ...
  public class OraOopUtilities {
      ...
      public static class JdbcOracleThinConnection {
          ...
          public String toString() {
            String url = null;
            // Use wallet if it's available
            if (this.wallet != null && !this.wallet.isEmpty()) {
               url = String.format("jdbc:oracle:thin:@%s", wallet);
            } else {
      ...
      public static String generateOracleWalletJdbcUrl(String wallet) {
          String url =  String.format("jdbc:oracle:thin:@%s", wallet);
          LOG.debug("Generating Wallet base URL : " + url);
          return url;
      }
