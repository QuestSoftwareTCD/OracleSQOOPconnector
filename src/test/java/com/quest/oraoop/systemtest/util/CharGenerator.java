...
/**
 * Generates String test data. All generated characters will be encodable in US-ASCII.
 * @author phall
 */
public class CharGenerator extends TestDataGenerator<String>
{
  private int minLength;
  private int maxLength;

  /**
   * Create a CharGenerator that will generate Strings between minLength and maxLength in length.
