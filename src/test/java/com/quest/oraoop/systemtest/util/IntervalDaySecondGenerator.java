 ...
 * @author phall
 */
public class IntervalDaySecondGenerator extends TestDataGenerator<String>
{
  ...
  /**
   * Create a generator that will generate intervals with the specified precision for days and seconds.
   * @param daysPrecision Number of decimal digits in the days part of each interval
   * @param secondsPrecision Number of decimal digits after the decimal point in seconds part of each interval.
   */
  ...
  public String next()
  {
    ...
    String val =
      String.format("%+0" + daysPrecision + "d %02d:%02d:%02d.%0" + secondsPrecision + "d", days, hours, minutes,
